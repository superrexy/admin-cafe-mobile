...
class PaymentSuccessView extends GetView<PaymentCheckController> {
                      ...
                      children: [
                        ...
                        Text(
                          controller.booking.value.isPaid == "SETTLEMENT"
                              ? "Berhasil"
                              : controller.booking.value.isPaid == "EXPIRES"
                                  ? "Kadaluarsa"
                                  : controller.booking.value.isPaid == "PENDING"
                                      ? "Menunggu Pembayaran"
                                      : controller.booking.value.isPaid ==
                                              "CANCEL"
                                          ? "Dibatalkan"
                                          : "",
                          style: AppTextStyle.body.copyWith(
